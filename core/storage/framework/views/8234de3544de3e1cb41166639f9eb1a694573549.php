...
<html lang="en">
   <head>
      ...
      <title><?php echo $__env->yieldContent('title'); ?> | Worldwide Travel & Tourism</title>
               ...
               <div class="container">
                  <div class="navbar-flex">
                     <div class="navbar-header">
                        ...
                        <img src="<?php echo e(asset('assets/images/logo.png')); ?>" width="150" alt="Worldwide Travel & Tourism"/>
                        </a>
                     </div>
                     <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav" id="responsive-menu">
                           <li class="<?php echo e(Route::currentRouteName() == 'front.home' ? 'active' : ''); ?>"><a href="/">Home</a></li>
                           <li class="<?php echo e(Route::currentRouteName() == 'front.about' ? 'active' : ''); ?>"><a href="<?php echo route('front.about'); ?>">About Us</a></li>
                           <li class="<?php echo e(Route::currentRouteName() == 'front.mice' ? 'active' : ''); ?>"><a href="<?php echo route('front.mice'); ?>">Mice</a></li>
                           <li class="submenu dropdown <?php echo e(Route::currentRouteName() == 'front.package' ? 'active' : ''); ?> || <?php echo e(Route::currentRouteName() == 'front.package.show' ? 'active' : ''); ?>">
                              ...
                              <ul class="dropdown-menu">
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<li><a href="<?php echo e(route('front.package', [$category->id, $category->slug])); ?>"><?php echo $category->name; ?></a></li>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                              </ul>
                           </li>
                           <li class="<?php echo e(Route::currentRouteName() == 'front.events' ? 'active' : ''); ?> || <?php echo e(Route::currentRouteName() == 'front.event.show' ? 'active' : ''); ?>"><a href="<?php echo route('front.events'); ?>">News</a></li>
                           <li class="<?php echo e(Route::currentRouteName() == 'front.blogs' ? 'active' : ''); ?> || <?php echo e(Route::currentRouteName() == 'front.blog.show' ? 'active' : ''); ?>"><a href="<?php echo route('front.blogs'); ?>">Events</a></li>
                                   <li><a href="https://worldwidetravel-lb.com/privacy">Policies</a></li>

                           <li class="<?php echo e(Route::currentRouteName() == 'front.contact' ? 'active' : ''); ?>"><a href="<?php echo route('front.contact'); ?>">Contact Us</a></li>
                        </ul>
                     </div>
...
<footer class="ww-footer">
  <div class="custom-footer-container ww-footer-inner">
    ...
    <div class="footer-left">
      <div class="footer-logo-wrap">
        <img src="<?php echo e(asset('assets/images/logo.png')); ?>" alt="Worldwide Travel & Tourism" class="footer-logo" style="width:185px;height:auto;">
      </div>
    ...
    <div class="footer-mid">
      <div class="footer-col">
        ...
        <ul>
          ...
          <li><a href="<?php echo e(route('front.mice')); ?>">MICE</a></li>
          <li><a href="<?php echo e(route('front.package', [$categories->first()->id ?? 1, $categories->first()->slug ?? 'packages'])); ?>">Packages</a></li>
          <li><a href="<?php echo e(route('front.events')); ?>">News</a></li>
          <li><a href="<?php echo e(route('front.blogs')); ?>">Events</a></li>
          <li><a href="https://worldwidetravel-lb.com/privacy">Policies</a></li>
          <li><a href="<?php echo e(route('whistle-blowing')); ?>">Whistle Blowing</a></li>
  ...
  <div class="custom-footer-bottom ww-bottom">
    <div class="custom-footer-copy">
      Copyright © <?php echo e(date('Y')); ?> Worldwide Travel & Tourism. All Rights Reserved.
    </div>
...
<div id="whatsapp-button">
  <a href="https://wa.me/96179119311" target="_blank" rel="noopener" aria-label="Chat on WhatsApp"></a>
      ...
      </script><script src="<?php echo e(asset('assets/js/jquery-3.3.1.min.js')); ?>"></script>
      <script src="<?php echo e(asset('assets/js/bootstrap.min.js')); ?>"></script>
      <script src="<?php echo e(asset('assets/js/plugin.js')); ?>"></script>
      <script src="<?php echo e(asset('assets/js/menu.js')); ?>"></script>
      <script src="<?php echo e(asset('assets/js/custom-swiper2.js')); ?>"></script>
...
</html><?php /**PATH /home/u133514729/domains/worldwidetravel-lb.com/public_html/core/resources/views/layouts/header.blade.php ENDPATH**/ ?>