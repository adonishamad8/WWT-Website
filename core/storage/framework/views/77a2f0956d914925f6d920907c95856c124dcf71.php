      ...
      <section class="why-us pad-top-80">
         <div class="container">
			...
			<?php $__currentLoopData = $abouts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $about): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<?php if($about->type == 'about'): ?>
               <div class="row display-flex">
                  <div class="col-lg-12 col-12">
                     <div class="why-about-inner mar-bottom-50">
                        <h2><?php echo $about->name; ?></h2>
                        <p><?php echo $about->description; ?></h2>
                     </div>
                  </div>
                  <div class="col-lg-12 col-12"> 
                     <div class="why-about-image">
                        <img src="<?php echo e($about->getFirstMediaUrl('about')); ?>" alt="<?php echo $about->name; ?>" />
                     </div>
                  </div>
               </div>
			   <?php endif; ?>
            ...
            <div class="why-us-box">
               <div class="row">
			<?php $__currentLoopData = $abouts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $about): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<?php if($about->type == 'mission'): ?>
                  <div class="col-lg-4 col-md-4 col-12">
                     <div class="why-us-item display-flex">
                        <div class="why-us-content">
                           <h3 class="mar-bottom-10"><?php echo $about->name; ?></h3>
                           <p class="mar-0"><?php echo $about->description; ?></p>
                        </div>
                     </div>
                  </div>
				<?php endif; ?>
                  ...
                  <div class="col-lg-3 col-sm-6">
                     <div class="agent-list">
                        <div class="agent-image">
                           <img src="<?php echo e($board->getFirstMediaUrl('board', 'thumb-large')); ?>" alt="<?php echo $board->name; ?>"/>
                           <div class="agent-content">
                              <h3 class="white mar-bottom-5"><?php echo $board->name; ?></h3>
                              <p class="white mar-0"><?php echo $board->position; ?></p>
                           </div>
                        </div>
                        <!--<div class="agent-social">
                           <ul class="social-links">
                              <li>
                                 <a target="_Blank" href="<?php echo $board->facebook; ?>"><i class="fab fa-facebook" aria-hidden="true"></i></a>
                              </li>
                              <li>
                                 <a target="_Blank" href="<?php echo $board->instagram; ?>"><i class="fab fa-instagram" aria-hidden="true"></i></a>
                              </li>
                              <li>
                                 <a target="_Blank" href="<?php echo $board->linkedin; ?>"><i class="fab fa-linkedin" aria-hidden="true"></i></a>
                              </li>
                           </ul>
                        </div> 
                        -->
...
<?php echo $__env->make('layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u133514729/domains/worldwidetravel-lb.com/public_html/core/resources/views/front/about.blade.php ENDPATH**/ ?>