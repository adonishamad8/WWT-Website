<?php $__env->startSection('title', 'Whistle Blowing | Worldwide Travel & Tourism'); ?>
...
<script type="text/javascript">
    ...
    $("form.ajax-form").submit(function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo e(route('front.sendemail')); ?>',
            dataType: 'json',
            processData: false,
            contentType: false,
            data: formData,
...
<?php echo $__env->make('layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u133514729/domains/worldwidetravel-lb.com/public_html/core/resources/views/front/whistle-blowing.blade.php ENDPATH**/ ?>