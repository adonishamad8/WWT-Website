@extends('layouts.cmslayout')
	...
	@endif
	<form class="form-horizontal" action="{{route('packages.store')}}" method="POST" enctype="multipart/form-data" data-parsley-validate novalidate>
		@csrf
		<div class="row">
			<div class="col-xl-8">
			   <div class="card-box">
				  <h4 class="header-title m-t-0 m-b-30">Edit Content</h4>
					...
					<div class="form-group row">
						<div class="col-md-1"></div>
						<label for="pdf" class="col-sm-2 col-form-label">PDF Brochure</label>
						<div class="col-sm-8">
