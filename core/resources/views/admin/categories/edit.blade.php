@extends('layouts.cmslayout')
	...
	@endif
    <form id="form" class="form-horizontal" action="{{route('categories.update', $category->id)}}" method="POST" enctype="multipart/form-data" data-parsley-validate novalidate>
		@method('put')
		@csrf
		<div class="row">
			<div class="col-xl-8">
				<div class="card-box">
							...
							<div class="tab-content">
								<div class="form-group row">
									<div class="col-md-1"></div>
									 ...
									 <div class="col-sm-8">
										<input type="text" name="name" class="form-control" value="{{$category->name}}" id="titleEn" placeholder="Title">
									 </div>
								</div>
							</div>
						</div>
							...
							<div class="col-md-3 gallery-pages">
								<div class="thumbnail">
									<div class="caption" style="display: none;">
										<h4>Image</h4>
										<p>
										   <a href="{{$category->getFirstMediaUrl('category', 'thumb-large')}}" data-lightbox="example-set" class="example-image-link badge badge-success">View</a>
										   <button id="remove-image" class="badge badge-danger">Remove</button>
										</p>
									</div>
									<img class="article-image" src="{{$category->getFirstMediaUrl('category', 'thumb')}}" width="100">
								</div>
							</div>
							@endif
							...
							<div class="tab-content">
								<div class="form-group row">
									<div class="col-md-1"></div>
									 ...
									 <div class="col-sm-8">
										<textarea id="editor-en" name="description">{{$category->description}}</textarea>
									 </div>
								</div>
							</div>
						</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-1">
							<label class="switch">
								<input type="checkbox" name="published" class="form-control" id="published" value="1" {{ ($category->published=="1")? "checked" : "" }}>
